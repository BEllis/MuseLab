...
/** Fill unset keys from a story's globalState without overwriting runtime values. */
function applyMissingGlobalStateDefaults(
  state: Record<string, unknown>,
...
export function createRunner(
  ...
  function switchStory(storyId: string, nodeId: string): void {
    ...
    applyMissingGlobalStateDefaults(state, activeStory.globalState);
