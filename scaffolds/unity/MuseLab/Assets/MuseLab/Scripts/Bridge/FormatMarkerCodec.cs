...
namespace MuseLab.Bridge
{
    ...
    public static class FormatMarkerCodec
    {
        ...
        static string KindToKey(FormatMarkerKind kind) => kind switch
        {
            ...
            FormatMarkerKind.UnderlineStart => "underlineStart",
            FormatMarkerKind.UnderlineEnd => "underlineEnd",
        ...
        static FormatMarkerKind KeyToKind(string key) => key switch
        {
            ...
            "underlineStart" => FormatMarkerKind.UnderlineStart,
            "underlineEnd" => FormatMarkerKind.UnderlineEnd,
